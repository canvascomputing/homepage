          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={siteConfig.githubUrl} target="_blank" rel="noopener noreferrer" 
                className="inline-flex items-center justify-center px-8 py-3 bg-[#3D709B] text-white font-semibold rounded-lg hover:bg-[#374049] transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
              ...
              <a href={siteConfig.huggingFaceUrl} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center justify-center px-8 py-3 border-4 border-[#374049] text-[#374049] font-semibold rounded-lg hover:bg-[#374049] hover:text-white transition-all duration-200">
                <img src="/hf-logo-pirate.svg" alt="Hugging Face" className="w-5 h-5 mr-2" />
                Hugging Face
              </a>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center mb-6">
              <img src="/malwi-logo.png" alt="malwi Logo" className="h-16 w-16 mr-4" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://huggingface.co/canvascomputing" target="_blank" rel="noopener noreferrer"
              ...
              <img src="/hf-logo-pirate.svg" alt="Hugging Face" className="w-5 h-5 mr-2 filter brightness-0 invert group-hover:filter-none group-hover:brightness-100 group-hover:invert-0" />
              View Models
            </a>
          </div>
        </div>
