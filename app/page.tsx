        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center">
            <div className="flex justify-center mb-8">
              <Image src="/logo.png" alt={siteConfig.labels.logoAlt} width={128} height={128} className="h-24 w-24 md:h-32 md:w-32 object-contain" priority />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 max-w-5xl mx-auto">
            <div className="flex items-center justify-center mb-8">
              <Image src="/malwi-logo.png" alt={siteConfig.labels.malwiLogoAlt} width={64} height={64} className="h-16 w-16 mr-4" />
              ...
              <div className="bg-[#F9F8F6] rounded-xl p-6">
                <div className="grid grid-cols-1 gap-3">
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-[#3D709B] mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                    </svg>
                    <span className="text-[#374049]">Scans Python code for malware</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-[#3D709B] mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                    </svg>
                    <span className="text-[#374049]">Works offline on your computer</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-[#3D709B] mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                    </svg>
                    <span className="text-[#374049]">Keeps your code private</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-[#3D709B] mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                    </svg>
                    <span className="text-[#374049]">Free and open source</span>
                  </div>
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-[#3D709B] mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                    </svg>
                    <span className="text-[#374049]">Made in the EU</span>
                  </div>
                </div>
              </div>
            </div>
