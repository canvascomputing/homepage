        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 lg:py-40">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-8 md:gap-10 lg:gap-24 xl:gap-32">
            ...
            <div className="text-center mb-8 lg:mb-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 sm:mb-0 max-w-md mx-auto sm:max-w-none">
                <a href={siteConfig.githubUrl} target="_blank" rel="noopener noreferrer" 
                  className="inline-flex items-center justify-center px-3 sm:px-6 md:px-8 py-3 bg-[#3D709B] text-white font-semibold rounded-lg hover:bg-[#374049] transition-colors duration-200 text-sm sm:text-base">
                ...
                <a href={siteConfig.huggingFaceUrl} target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-3 sm:px-6 md:px-8 py-3 border-4 border-[#374049] text-[#374049] font-semibold rounded-lg hover:bg-[#374049] hover:text-white transition-colors duration-200 text-sm sm:text-base">
      ...
      <section id="malwi" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <p className="text-xl md:text-2xl text-[#666666] -mt-1 mb-4">
            ...
            <div className="text-center lg:text-left max-w-xl lg:flex-1">
              ...
              <div className="text-center lg:text-left">
                <a href={siteConfig.content.malwi.githubUrl} target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center justify-center px-10 py-4 bg-[#3D709B] text-white font-semibold rounded-lg hover:bg-[#374049] transition-colors duration-200 shadow-lg hover:shadow-xl">
            ...
            <div className="lg:flex-shrink-0 mt-8 lg:mt-0">
              <div className="bg-[#1a1a1a] text-gray-300 font-mono text-xs p-6 rounded-lg shadow-2xl w-full max-w-3xl">
                <div className="space-y-1 text-[10px] leading-relaxed whitespace-pre-wrap">
                  <div className="text-gray-300">$ <span className="text-blue-400">malwi</span> <span className="text-gray-100">scan discordpydebug-0.0.4/</span></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto sm:max-w-none">
            <a href="https://github.com/canvascomputing" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-3 sm:px-6 md:px-8 py-3 bg-white text-[#374049] font-semibold rounded-lg hover:bg-gray-100 transition-colors text-sm sm:text-base">
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
              </svg>
            ...
            <a href="https://huggingface.co/canvascomputing" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-3 sm:px-6 md:px-8 py-3 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-[#374049] transition-colors group text-sm sm:text-base">
